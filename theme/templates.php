        ...
        <div class="navbar navbar-default navbar-static-top" > 
            <div class="container" style="width: 100%;">
                <div class="navbar-header">
                    ...
                    <!--<a class="navbar-brand" href="<?php echo web_root; ?>index.php">--><img class="navbar-brand"  src="<?php echo web_root; ?>plugins/home-plugins/img/joberfiedbanner.png" alt="logo" /> </a>
                </div>
                <div class="navbar-collapse collapse ">
                    <ul class="nav navbar-nav" style="float: right: margin-right: 2em;">
                      ...
                      <li class="dropdown <?php  if(isset($_GET['q'])) { if($_GET['q']=='category'){ echo 'active'; }else{ echo ''; }}  ?>">
                       ...
                       <!-------------------------------------------------CAREER START--------------------------------------------------------------------->
                       <li class="dropdown">
                          <a href="#" data-toggle="dropdown" class="dropdown-toggle">Career <b class="caret"></b></a>
                          <ul class="dropdown-menu">
                              <li class="<?php  if(isset($_GET['q'])) { if($_GET['q']=='advancesearch'){ echo 'active'; }else{ echo ''; }}  ?>"><a href="<?php echo web_root; ?>index.php?q=advancesearch">Local Recruitment Activity </a></li>
                              <li><a href="<?php echo web_root; ?>index.php?q=search-company">Job Fair</a></li>
                              <li><a href="<?php echo web_root; ?>index.php?q=search-function">Special Recruitment Activity</a></li>
                              <li><a href="<?php echo web_root; ?>index.php?q=search-jobtitle">Career Guidance and Employment Coaching</a></li>
                         <!--      <li><a href="#">Job for Women</a></li>
                              <li><a href="#">Job for Men</a></li> -->
                          </ul>
                       </li>
